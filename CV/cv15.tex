...
%
 https://orcid.org/0000-0002-3127-5520. 
  8 research papers (7 first author), 3 reviews, 1 Scienceopen collection. meeting presentation > 26\\
 https://github.com/jcolomb. 
...
\emph{Organisation:} Outlook, Access, Zoho;
\emph{Publishing:} \LaTeX, Office; html;
\emph{ Image processing:} Photoshop, Illustrator, Image J; 
\emph{Programming:}  R (advanced), Git, Labview
