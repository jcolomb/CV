...
\parbox[t]{0.83\textwidth}{Free lance scientist,\\
        Animal core facility: organisation lead,\\
        Phenobase: literature curation.}
...
- Workshop prepareation "Effective workflow for reproducible science"\\
...
\\
11 research papers (7 first author), 3 Open source software (2 main author)
