...
\parbox[t]{0.83\textwidth}{Free lance scientist,\\
        Animal core facility (Charit\'e): organisation lead,\\
...
- Workshop preparation "Effective workflow for reproducible science"\\
...
\newblock \bibinfo{journal}{PeerJ}
  (\bibinfo{pages}{e1971}).
  \\cited 1 times%, from which 0 reviews and 1 self 
...
\newblock \bibinfo{journal}{Plos One}
  ...
  \\cited 7-8 times%, from which 0 reviews and 1 self 
...
%\newpage
\rubrique{Meeting presentations (6 most representative)}
