...
\parbox[t]{0.83\textwidth}{Founder and CEO 
       of Drososhare GmbH (Berlin, Germany),\\
        a company aiming to facilitate fly stock exchanges between scientists.}
...
\rubrique{Education}
\parbox{0.15\textwidth}{2012-2013}\hfill
\parbox[t]{0.83\textwidth}{Moderation and management (Continuing Education), 56 hours, Artop (Berlin).
        }\vskip 0.1em
...
\\
(5 first author research papers, 3 others, 1 Open source software)
...
\begin{sloppypar}
%
\item(2011-2013) CeTrAn 1.4 to 4.0, available at www.buridan.sourceforge.net. Used for at least two research papers.
%
%
\end{sloppypar}
\end{itemize}
...
\rubrique{Meeting presentations (seventh most representative)}
%
