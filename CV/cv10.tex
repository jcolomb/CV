...
\begin{sloppypar}
%
\item(2011-2013) CeTrAn 1.4 to 4.0, available at www.buridan.sourceforge.net, developed in Github (https://github.com/jcolomb/CeTrAn). Used for at least two research papers.
%
%
\end{sloppypar}
\end{itemize}
