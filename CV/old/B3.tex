...
\parbox{0.15\textwidth}{2007-present}\hfill
\parbox[t]{0.83\textwidth}{Postdoctoral fellow\\
       ESPCI (France)\\
        working on "appetitive learning in Drosophila"\\
...
\parbox[t]{0.83\textwidth}{``Maturité fédérale type C'' (scientific subsection),
in the "Collège de la royale Abbaye de St. Maurice"}
...
Publishing: \TeX, Photoshop, Illustrator, Image J, HTML, Office
...
\providecommand{\bibinfo}[2]{#2}
 ...
 \item   (\bibinfo{year}{In prep.}).  
 \bibinfo{author}{\textbf{Julien~Colomb}}\\
\newblock \enquote{\bibinfo{title}{New insights into  \textit{Drosophila} appetitive LTM and sugar motivation: previous interpretations in question}}
\newblock \bibinfo{book}{In press: Book chapter for novapublisher group.}
...
\bibinfo{author}{Anne Schröck}, \bibinfo{author}{Reinhard F. Stocker}, and \bibinfo{author}{Michael J. Pankratz}.
\\
...
%\item[4]
%\bibinfo{author}{\textbf{Julien~Colomb}}, \bibinfo{author}{Claire~Huguenin},
%  \bibinfo{author}{Reinhard F.~Stocker}, and \bibinfo{author}{Ariane~Ramaekers}.
%  \\
%\newblock \enquote{\bibinfo{title}{A role for NO in olfactory adaptation?}}.
%%\newblock \bibinfo{journal}{}
% % \textbf{\bibinfo{volume}{41}}(\bibinfo{number}{1}): \bibinfo{pages}{27--37}
%  (\bibinfo{year}{in preparation}).
...
%\parbox{0.15\textwidth}{2005}\hfill
%\parbox[t]{0.83\textwidth}{Les projections des neurones gustatifs: ségrégation selon l'organe d'origine.
%Talk at the "rencontre du club de neurobiologie des invertébrés", Paris.}\vskip 0.1em
%\parbox{0.15\textwidth}{2004}\hfill
...
%OF DROSOPHILA LARVAE meeting in Würzburg, Germany.}\vskip 0.1em
%
%\parbox{0.15\textwidth}{2002}\hfill
...
neurobiologie des invertébrés", Versailles.
...
%\item[2005] Les projections des neurones gustatifs: ségrégation
%selon l'organe d'origine.
%\\ORAL PRESENTATION at the "rencontre du club de
%neurobiologie des invertébrés", Paris.
...
behavioural neurobiology of \textit{Drosophila} larvae meeting in Würzburg,
Germany.
...
I already took great part in the redaction of my papers of my thesis, but I recently became  able to write a whole paper (or mini-review) with little help from my supervisors.
...
All these elements show that I have initiative and that I can manage a project from the beginning to the end. 
