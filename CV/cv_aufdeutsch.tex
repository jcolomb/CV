...
\rubrique{Berufliche Erfahrungen}
\parbox{0.15\textwidth}{2009-2012}\hfill
\parbox[t]{0.83\textwidth}{Postdoctoral fellow (Wissenschaftliche Mitarbeiter)\\
       FU (Berlin)\\
        %working on "the what and where of operant learning in \textit{Drosophila}"\\
        %Coworker: Dr. hab. B. Brembs
        }
\parbox{0.15\textwidth}{2007-2008}\hfill
\parbox[t]{0.83\textwidth}{Postdoctoral fellow (Wissenschaftliche Mitarbeiter)\\
       ESPCI (France)\\
       % working on "appetitive learning in \textit{Drosophila}"\\
       % Supervisor: Dr. T. Preat
      }
\rubrique{Ausbildung}
\parbox{0.15\textwidth}{2006}\hfill
\parbox[t]{0.83\textwidth}{Doktorarbeit in Biologie\\
        Universität Fribourg (CH).\\
        Thema: ``The chemosensory system of \textit{Drosophila} larvae: neuroanatomy and behaviour''\\
        %Thesis director: Prof. R.F Stocker
        }
        %\vskip 0.1em
\parbox{0.15\textwidth}{2002}\hfill
\parbox[t]{0.83\textwidth}{Diplom in Biologie\\
        Universität of Fribourg (CH)\\
...
\parbox[t]{0.83\textwidth}{Abitur: ``Maturit\'e f\'ed\'erale type C'',
in den "Coll\`ege de la royale Abbaye de St. Maurice"}
...
%\parbox[t]{0.83\textwidth}{Forschungsgruppe "biogenic amines in insects". Grant cowritten with B.Brembs }\vskip 0.1em
%
%\parbox{0.15\textwidth}{2009}\hfill
%\parbox[t]{0.83\textwidth}{SNF for avanced researchesr : PA00P3-124141 - The what and where of operant learning in \textit{Drosophila} }\vskip 0.1em
%
%
...
%
\rubrique{Publikationen}
%
Vier veröffentlichte Publikationen als Erstautor in internationalen wissenschaflichen Zeitschriften.
\\
Drei review-Artikel als Ersautor.
\\
Zwei eingereichte Publikationen, davon eins als Erstautor.

\rubrique{Lehre}
%
\parbox{0.15\textwidth}{2011}\hfill
\parbox[t]{0.83\textwidth}{Praktika Neurobiologie. (7 mal 4 Stunden)}
\parbox{0.15\textwidth}{2011}\hfill
\parbox[t]{0.83\textwidth}{Entwicklung der Insekten  (2 Stunden Kurs)}
%
%
%
\parbox{0.15\textwidth}{2006}\hfill
\parbox[t]{0.83\textwidth}{Fluorescence and Confocal Microscopy (Kurs zum master studenten, auf Englisch, 3 Stunden)}
\parbox{0.15\textwidth}{2003--2006}\hfill
\parbox[t]{0.83\textwidth}{Studying behavior. (auf English, 2 Stunden)}
...
%	\parbox[t]{0.83\textwidth}{Co-supervisor of the PhD student Chistine Damrau
...
Französisch (Muttersprache), English (fliessend),
Deutsch (fliessend), Spanisch (Grundkenntnisse).


\rubrique{EDV}
 \TeX, Office; html;\\ Photoshop, Illustrator, Image J; 
\\  Labview, R (freeware for statistics)

%\rubrique{reviewer for the following journals}
%Current Biology, Proceedings of the royal society B,  The Journal of Experimental Biology, learning and memory, PLoS one, JEAB
%\\ Associate member of faculty of 1000 

\rubrique{Andere Tätigkeiten} 
%2007  Creation of the T. Preat's lab website.
%\\
%2004. Creation of the R.F. Stocker's lab website.
%
2006: Co-Regisseur in der Theatergruppe "les apostrophes" 
\\2002-2005: Schauspieler und Kassier in der Theatergruppe "les apostrophes" 
\\1995-2001: Sommerjob in einem Bauunternehmen
...
%  \bibinfo{author}{Jan~Wessnitzer} and \bibinfo{author}{Bjoern~Brembs}. \\
%\newblock \enquote{\bibinfo{title}{Open source software to track and analyse locomotion: computer simulation versus
%\textit{Drosophila} imago in Buridan's arena.}}.
...
%  \bibinfo{author}{Hans-Joachim~Pflueger}, \bibinfo{author}{Troy~Zars}, \bibinfo{author}{Constance~Scharff} and \bibinfo{author}{Bjoern~Brembs}. \\
...
%   \\cited 13 times%, from which 0 reviews and 1 self
%   
%
%   
%
...
%   \\  cited 29 times%, from which 2 reviews and 7 self
...
% \\ cited 27 times%, from which at least 4 reviews and 8 self
%%\google scholar
%\item  (\bibinfo{year}{2007}).
...
%
%
%\textbf{Choice of meetings presentation}
%%
%%\parbox{0.15\textwidth}{2005}\hfill
...
%%\parbox{0.15\textwidth}{2005}\hfill
%%\parbox[t]{0.83\textwidth}{Les projections des neurones gustatifs: sï¿½grï¿½gation selon l'organe d'origine.
%%Talk at the "rencontre du club de neurobiologie des invertï¿½brï¿½s", Paris.}\vskip 0.1em
%%\parbox{0.15\textwidth}{2004}\hfill
...
%%OF DROSOPHILA LARVAE meeting in Wï¿½rzburg, Germany.}\vskip 0.1em
%%
%%\parbox{0.15\textwidth}{2002}\hfill
...
%\\POSTER PRESENTATION at the GNS meeting, Göttingen, Germany.
%
...
%%neurobiologie des invertï¿½brï¿½s", Versailles.
%
...
%
%%%\item[2005] Les projections des neurones gustatifs: sï¿½grï¿½gation
%%%selon l'organe d'origine.
%%%\\ORAL PRESENTATION at the "rencontre du club de
%%%neurobiologie des invertï¿½brï¿½s", Paris.
%
%%
%%\item[2004]
...
%%\\POSTER at the
%%"Neurofly" meeting in Neuchï¿½tel
%
%%%\item[2004]
...
%behavioural neurobiology of \textit{Drosophila} larvae meeting, Würzburg,
%Germany.
%
%%\item[2002]
