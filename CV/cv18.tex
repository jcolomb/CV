...
\begin{minipage}[t]{\textwidth}
    ...
    \begin{minipage}[b]{0.5\textwidth}
        \begin{flushright}
            \fbox{\includegraphics[scale=0.3] {Figures/photo_CV.png}}
        \end{flushright}
    \end{minipage}
\end{minipage}\\
...
\rubrique{Research service activities}
%
...
\rubrique{Supervision of students}
...
(master, 2 h. lecture%, part of the lecture course "Developmental- and Neurogenetics" given by R.F. Stocker
).}
...
%\\
Volunteer for FORCE11 communication,
